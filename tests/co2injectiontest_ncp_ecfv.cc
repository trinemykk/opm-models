 ...
 * \file
 *
 * \brief Test for the isothermal ncp model using a CO2 injection
...
namespace TTag {
struct Co2InjectionNcpEcfvProblem { using InheritsFrom = std::tuple<Co2InjectionTestBaseProblem, NcpModel>; };
} // end namespace TTag
