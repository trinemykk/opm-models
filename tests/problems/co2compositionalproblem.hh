 ...
 * \file
 *
 * \copydoc Opm::CO2compositionalproblem
 */
...
public:
    using type = Opm::Co2BrineFluidSystem<Scalar>;
};
...
struct SimulationName<TypeTag, TTag::Co2InjectionCompositional> {
    static constexpr auto value = "co2compositional";
};
 ...
 *
 * \brief 2 component testproblem with CO2 and Brine
 *
 *
 *
 *
